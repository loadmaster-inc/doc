...
![](../.gitbook/assets/wei-xin-jie-tu-20200729150233.png)
...
比如：当前计算任务中输入的货物条目数（也就是行数）有5行，货物总体积是23.5立方，那么应扣装箱点=24\*1\*1=24个装箱点。

![](../.gitbook/assets/4566+import.png)
